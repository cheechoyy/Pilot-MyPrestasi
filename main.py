...
# 1. Page Configuration (Mesti dipanggil pada baris pertama)
st.set_page_config(page_title="MyPrestasi HPU", layout="wide")

# 2. Modern SaaS Theme & Global CSS
...
if "selected_view" not in st.session_state:
    st.session_state["selected_view"] = "Main Dashboard" # Ditukar ke EN selari dengan logic baru
